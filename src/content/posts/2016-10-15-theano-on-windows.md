...
description: "Deep learning is hot! Mostly due to significantly improved results that you might have heard about. The use of graphical processing units (GPUs) that can perform many calculations…"
date: "2016-10-15"
draft: false
tags: ["data-science"]
...
> If you are setting up a deep-learning box today, use PyTorch or JAX. This
> post is kept for historical reference.
